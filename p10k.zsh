# Generated by Powerlevel10k configuration wizard on 2022-04-30 at 22:38 UTC.
...
() {
  ...
  # directories. It must be an array with 3 * N elements. Each tiplet consists of:
  #
...
# para que no muestre el warning al abrir una consola
